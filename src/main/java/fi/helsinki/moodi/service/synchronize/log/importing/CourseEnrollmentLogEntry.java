...
public class CourseEnrollmentLogEntry implements LogEntry {

    private final CourseEnrollmentStatus courseEnrollmentStatus;
    private final String title;
    private final String timestamp;

    public CourseEnrollmentLogEntry(CourseEnrollmentStatus courseEnrollmentStatus, String title, String timestamp) {
