...
public class EnrollmentWarning {
    ...
    public static final String CODE_USER_WITHOUT_USERNAME = "user-without-username";
    ...
    public static EnrollmentWarning userWithoutUsername(final Enrollment enrollment) {
        return new EnrollmentWarning(CODE_USER_WITHOUT_USERNAME, enrollment);
    }
