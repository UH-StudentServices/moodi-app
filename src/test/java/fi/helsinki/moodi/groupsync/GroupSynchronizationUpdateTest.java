...
public class GroupSynchronizationUpdateTest extends AbstractGroupSynchronizationBaseTest {
    ...
    @Before public void initialize() {
        ...
        moodleGroupings = Arrays.asList(
            ...
            createMoodleGrouping(2L, moodleCourseId, "sisu:grouping2", Arrays.asList(moodleGroups.get(2), moodleGroups.get(3))),
        ...
        List<SisuStudyGroupSet> sisuStudyGroupSets = Arrays.asList(
            createSisuStudyGroupSet("grouping1", Collections.singletonList(sisuStudySubGroups.get(0))),
            createSisuStudyGroupSet("grouping2", Arrays.asList(sisuStudySubGroups.get(1), sisuStudySubGroups.get(2)))
        );
    ...
    public void testUpdateGroupsProcess() {
        ...
        verify(moodleService, times(2)).deleteGroup(any());
