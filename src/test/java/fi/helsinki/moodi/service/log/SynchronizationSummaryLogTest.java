...
public class SynchronizationSummaryLogTest extends AbstractSummaryLogTest {
    ...
    private static final String ENRICHMENT_SUCCESSFULL_MESSAGE = "Enrichment successfull";
    ...
    public void thatSynchronizationSummaryLogIsCreated() {
        ...
        SynchronizationItem completedItem = itemWithUserItems
            .completeEnrichmentPhase(EnrichmentStatus.SUCCESS, ENRICHMENT_SUCCESSFULL_MESSAGE)
        ...
        assertEquals(ENRICHMENT_SUCCESSFULL_MESSAGE, synchronizationItemLogEntry.enrichmentMessage);
